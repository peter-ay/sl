...
{
    public partial class DSale_PriceContract_Lens : DALBase
    {
        public DSale_PriceContract_Lens()
        { }

        public override bool Exists(string dbCode, int lgIndex, string vCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Sale_PriceContract_Lens with (nolock)");
        ...
        {
            var model = t as MSale_PriceContract_Lens;
            StringBuilder strSql = new StringBuilder();
            //////////////////////////////////////////
            ...
            parameters[12].Value = model.P1JM;
            parameters[13].Value = model.P2JM;
            parameters[14].Value = model.InvTitle;
