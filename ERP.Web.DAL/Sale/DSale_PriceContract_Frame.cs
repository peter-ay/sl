...
{
    public partial class DSale_PriceContract_Frame : DALBase
    {
        public DSale_PriceContract_Frame()
        { }

        public override bool Exists(string dbCode, int lgIndex, string vCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Sale_PriceContract_Frame with (nolock)");
        ...
        {
            var model = t as MSale_PriceContract_Frame;
            StringBuilder strSql = new StringBuilder();
            //////////////////////////////////////////
            ...
            parameters[4].Value = model.PriceJM;
            parameters[5].Value = model.InvTitle;
