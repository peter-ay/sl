...
{
    public partial class DB_Material_LensClass_DefaultCoating : DALBase
    {
        public DB_Material_LensClass_DefaultCoating()
        { }

        public override bool Exists(string dbCode, int lgIndex, string vCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from B_Material_LensClass_DefaultCoating with (nolock)");
        ...
        {
            MB_Material_LensClass_DefaultCoating model = t as MB_Material_LensClass_DefaultCoating;
            StringBuilder strSql = new StringBuilder();
        ...
        {
            var model = t as MB_Material_LensClass_DefaultCoating;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update B_Material_LensClass_DefaultCoating set ");
