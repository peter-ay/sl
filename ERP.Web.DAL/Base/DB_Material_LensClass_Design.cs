...
{
    public partial class DB_Material_LensClass_Design : DALBase
    {
        public DB_Material_LensClass_Design()
        { }

        public override bool Exists(string dbCode, int lgIndex, string vCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from B_Material_LensClass_Design with (nolock)");
        ...
        {
            var model = t as MB_Material_LensClass_Design;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update B_Material_LensClass_Design set ");
