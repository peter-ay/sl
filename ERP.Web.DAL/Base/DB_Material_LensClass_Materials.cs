...
{
    public partial class DB_Material_LensClass_Materials : DALBase
    {
        public DB_Material_LensClass_Materials()
        { }

        public override bool Exists(string dbCode, int lgIndex, string vCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from B_Material_LensClass_Materials with (nolock)");
        ...
        {
            var model = t as MB_Material_LensClass_Materials;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update B_Material_LensClass_Materials set ");
