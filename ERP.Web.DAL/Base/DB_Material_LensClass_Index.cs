...
{
    public partial class DB_Material_LensClass_Index : DALBase
    {
        public DB_Material_LensClass_Index()
        { }

        public override bool Exists(string dbCode, int lgIndex, string vCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from B_Material_LensClass_Index with (nolock)");
        ...
        {
            MB_Material_LensClass_Index model = t as MB_Material_LensClass_Index;
            StringBuilder strSql = new StringBuilder();
        ...
        {
            var model = t as MB_Material_LensClass_Index;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update B_Material_LensClass_Index set ");
