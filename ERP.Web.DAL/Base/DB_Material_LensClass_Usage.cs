...
{
    public partial class DB_Material_LensClass_Usage : DALBase
    {
        public DB_Material_LensClass_Usage()
        { }
        ...
        {
            var model = t as MB_Material_LensClass_Usage;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update B_Material_LensClass_Usage set ");
