...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSWare_Bill : DomainService
    {
        private IDAL bll = new BWare_Bill();
        private IDALCheck bllCheck = new BWare_Bill();
        private IDALUpdateEdit bllUpdateEdit = new BWare_Bill();
