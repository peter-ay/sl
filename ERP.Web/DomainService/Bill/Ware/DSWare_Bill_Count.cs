...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSWare_Bill_Count : DomainService
    {
        private IDAL bll = new BWare_Bill_Count();
        private IDALCheck bllCheck = new BWare_Bill_Count();
        private IDALUpdateEdit bllUpdateEdit = new BWare_Bill_Count();
        ...
        [Invoke]
        public void Update(string dbCode, int lgIndex, MWare_Bill_Count t)
        {
