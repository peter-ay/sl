...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSB_Material_LensClass_Usage : DomainService
    {
        private BLLBase bll = new BB_Material_LensClass_Usage();

        [Invoke]
        public string Add(string dbCode, int lgIndex, MB_Material_LensClass_Usage t)
        {
            return bll.Add(dbCode, lgIndex, t, false);
        }

        [Invoke]
        public void Update(string dbCode, int lgIndex, MB_Material_LensClass_Usage t)
        {
