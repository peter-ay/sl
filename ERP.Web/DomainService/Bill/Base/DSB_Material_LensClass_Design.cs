...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSB_Material_LensClass_Design : DomainService
    {
        private BLLBase bll = new BB_Material_LensClass_Design();

        [Invoke]
        public string Add(string dbCode, int lgIndex, MB_Material_LensClass_Design t)
        {
            return bll.Add(dbCode, lgIndex, t, false);
        }

        [Invoke]
        public void Update(string dbCode, int lgIndex, MB_Material_LensClass_Design t)
        {
