...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSB_Material_LensClass_DefaultCoating : DomainService
    {
        private BLLBase bll = new BB_Material_LensClass_DefaultCoating();
        ...
        [Invoke]
        public void Update(string dbCode, int lgIndex, MB_Material_LensClass_DefaultCoating t)
        {
