...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSPur_PriceContract_Lens_ProCost : DomainService
    {
        private BLLBase bll = new BPur_PriceContract_Lens_ProCost();
        ...
        [Invoke]
        public void Update(string dbCode, int lgIndex, MPur_PriceContract_Lens_ProCost t)
        {
