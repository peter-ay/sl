...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSPur_PriceContract_FrameSet : DomainService
    {
        private BLLBase bll = new BPur_PriceContract_FrameSet();
         
        [Invoke]
        public string Add(string dbCode, int lgIndex, MPur_PriceContract_FrameSet t)
        {
            return bll.Add(dbCode, lgIndex, t, false);
        }

        [Invoke]
        public void Update(string dbCode, int lgIndex, MPur_PriceContract_FrameSet t)
        {
