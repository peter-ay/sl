...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSSale_PriceContract_Frame : DomainService
    {
        private BLLBase bll = new BSale_PriceContract_Frame();
        ...
        [Invoke]
        public void Update(string dbCode, int lgIndex, MSale_PriceContract_Frame t)
        {
