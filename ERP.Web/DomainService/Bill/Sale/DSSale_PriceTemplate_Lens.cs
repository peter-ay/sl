...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSSale_PriceTemplate_Lens : DomainService
    {
        [Invoke]
        public void AddPrice(string dbCode, int lgIndex, MSale_PriceTemplate_Lens t)
        {
            var model = t;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Sale_PriceTemplate_Lens(");
        ...
        public void DeletePrice(string dbCode, int lgIndex, List<string> codes)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(SPName.SP_Sale_PriceTemplate_Lens_Delete);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(SPName.SP_Sale_PriceTemplate_Lens_Copy);
            SqlParameter[] parameters = new SqlParameter[] { 
            new SqlParameter("@LgIndex", SqlDbType.Int),
        ...
        public void EditPrice(string dbCode, int lgIndex, List<string> codes, decimal p1, decimal p2)
        {
            ...
            codes.ForEach(item => { str += item + ";"; });
            StringBuilder strSql = new StringBuilder();
            strSql.Append(SPName.SP_Sale_PriceTemplate_Lens_Edit);
            SqlParameter[] parameters = new SqlParameter[] { 
            new SqlParameter("@LgIndex", SqlDbType.Int),
            new SqlParameter("@PKCode", SqlDbType.VarChar,2000),
            new SqlParameter("@P1", SqlDbType.Decimal,9),
