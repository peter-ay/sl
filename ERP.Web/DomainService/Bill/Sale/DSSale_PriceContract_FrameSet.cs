...
namespace ERP.Web.DomainService.Bill
{
    ...
    [EnableClientAccess()]
    public class DSSale_PriceContract_FrameSet : DomainService
    {
        private BLLBase bll = new BSale_PriceContract_FrameSet();
         
        [Invoke]
        public string Add(string dbCode, int lgIndex, MSale_PriceContract_FrameSet t)
        {
            return bll.Add(dbCode, lgIndex, t, false);
        }

        [Invoke]
        public void Update(string dbCode, int lgIndex, MSale_PriceContract_FrameSet t)
        {
