namespace ERP.Web.DomainService.Erp
{
    ...
    public partial class DSErp
    {
        ...
        public IQueryable<V_B_Material_LensSmart> GetV_B_Material_LensSmartHelpList(string dbCode)
        {
        ...
        public IQueryable<V_B_Material_LensSmart> GetV_B_CusLensSmartHelpList(string dbCode, string cusCode)
        {
            this.ObjectContext.ChangeDataBase(dbCode);
            ...
            var rs = this.ObjectContext.V_B_Material_LensSmart.
                Where(item => _CodesList.Contains(item.LensCode.ToUpper()));
