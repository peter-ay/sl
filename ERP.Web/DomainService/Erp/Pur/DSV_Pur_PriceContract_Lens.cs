...
namespace ERP.Web.DomainService.Erp
{
    ...
    {
        public IQueryable<V_Pur_PriceContract_Lens> GetV_Pur_PriceContract_LensList(string dbCode, string sWhere)
        {
            this.ObjectContext.ChangeDataBase(dbCode);

            IQueryable<V_Pur_PriceContract_Lens> _Rs = this.ObjectContext.V_Pur_PriceContract_Lens;
