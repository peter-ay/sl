...
namespace ERP.Web.DomainService.Erp
{
    ...
    {
        public IQueryable<V_Pur_PriceContract_FrameSet> GetV_Pur_PriceContract_FrameSetList(string dbCode, string sWhere)
        {
            this.ObjectContext.ChangeDataBase(dbCode);

            IQueryable<V_Pur_PriceContract_FrameSet> rs = this.ObjectContext.V_Pur_PriceContract_FrameSet;
