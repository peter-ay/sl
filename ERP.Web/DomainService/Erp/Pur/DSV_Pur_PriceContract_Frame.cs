...
namespace ERP.Web.DomainService.Erp
{
    ...
    {
        public IQueryable<V_Pur_PriceContract_Frame> GetV_Pur_PriceContract_FrameList(string dbCode, string sWhere)
        {
            this.ObjectContext.ChangeDataBase(dbCode);

            IQueryable<V_Pur_PriceContract_Frame> rs = this.ObjectContext.V_Pur_PriceContract_Frame;
