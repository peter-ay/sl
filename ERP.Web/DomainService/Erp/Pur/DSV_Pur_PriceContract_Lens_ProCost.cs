...
namespace ERP.Web.DomainService.Erp
{
    ...
    {
        public IQueryable<V_Pur_PriceContract_Lens_ProCost> GetV_Pur_PriceContract_Lens_ProCostList(string dbCode, string sWhere)
        {
            this.ObjectContext.ChangeDataBase(dbCode);

            IQueryable<V_Pur_PriceContract_Lens_ProCost> _Rs = this.ObjectContext.V_Pur_PriceContract_Lens_ProCost;
