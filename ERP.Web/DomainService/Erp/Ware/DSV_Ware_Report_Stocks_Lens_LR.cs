...
namespace ERP.Web.DomainService.Erp
{
    ...
    {
        public IQueryable<V_Ware_Report_Stocks_Lens_LR> GetV_Ware_Report_Stocks_Lens_LRList(string dbCode, string sWhere)
        {
            this.ObjectContext.ChangeDataBase(dbCode);

            IQueryable<V_Ware_Report_Stocks_Lens_LR> _Rs = this.ObjectContext.V_Ware_Report_Stocks_Lens_LR;
