...
{
    public class ImportB_Material_LensClass_Brand : ImportBase
    {
        protected override void PrepareImport(SqlCommand cmd, DataSet ds)
        {
            ...
            //
            strSql.Clear();
            strSql.Append("select top 0 * into #B_Material_LensClass_Brand from B_Material_LensClass_Brand;");
            ...
            {
                strSql.Clear();
                strSql.Append("Delete #B_Material_LensClass_Brand where KeyCode=@KeyCode;");
                //
            ...
            //
            strSql.Clear();
            strSql.Append("delete B_Material_LensClass_Brand;");
            strSql.Append("insert into B_Material_LensClass_Brand select * from #B_Material_LensClass_Brand;");
            cmd.CommandText = strSql.ToString();
            cmd.ExecuteNonQuery();
        }
    }
