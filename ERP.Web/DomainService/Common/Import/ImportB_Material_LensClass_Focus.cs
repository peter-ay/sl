...
{
    public class ImportB_Material_LensClass_Focus : ImportBase
    {
        protected override void PrepareImport(SqlCommand cmd, DataSet ds)
        {
            ...
            //
            strSql.Clear();
            strSql.Append("select top 0 * into #B_Material_LensClass_Focus from B_Material_LensClass_Focus;");
            ...
            {
                strSql.Clear();
                strSql.Append("Delete #B_Material_LensClass_Focus where KeyCode=@KeyCode;");
                //
                strSql.Append("insert into #B_Material_LensClass_Focus(");
            ...
            //
            strSql.Clear();
            strSql.Append("delete B_Material_LensClass_Focus;");
            strSql.Append("insert into B_Material_LensClass_Focus select * from #B_Material_LensClass_Focus;");
            cmd.CommandText = strSql.ToString();
            cmd.ExecuteNonQuery();
        }
    }
