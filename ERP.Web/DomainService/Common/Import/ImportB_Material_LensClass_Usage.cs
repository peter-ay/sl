...
{
    public class ImportB_Material_LensClass_Usage : ImportBase
    {
        protected override void PrepareImport(SqlCommand cmd, DataSet ds)
        {
            ...
            //
            strSql.Clear();
            strSql.Append("select top 0 * into #B_Material_LensClass_Usage from B_Material_LensClass_Usage;");
            ...
            {
                strSql.Clear();
                strSql.Append("Delete #B_Material_LensClass_Usage where KeyCode=@KeyCode;");
                //
                strSql.Append("insert into #B_Material_LensClass_Usage(");
            ...
            //
            strSql.Clear();
            strSql.Append("delete B_Material_LensClass_Usage;");
            strSql.Append("insert into B_Material_LensClass_Usage select * from #B_Material_LensClass_Usage;");
            cmd.CommandText = strSql.ToString();
            cmd.ExecuteNonQuery();
        }
    }
