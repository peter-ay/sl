...
namespace ERP.View
{
    public partial class DataGridListErp : UserControl
    {
        private string MyListName;

        public DataGridListErp()
        {
            InitializeComponent();
            ...
            Messenger.Default.Register<ObservableCollection<DataGridColumn>>(this, USysMessages.InitGridColumns, (columns) =>
            {
