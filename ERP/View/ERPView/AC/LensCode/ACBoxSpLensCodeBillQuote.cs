...
namespace ERP.View
{
    public class ACBoxSpLensCodeBillQuote : ACBoxLensCodeBill
    {
        public ACBoxSpLensCodeBillQuote()
        {
            this.InitMessages();
        ...
        private void InitMessages()
        {
            ...
            Messenger.Default.Register<string>(this, USysMessages.ACBoxLensCodeQuoteTextUpdateEnd, (msg) =>
            {
                ...
                this.ItemsSource = ComHelpLensCode.UHV_B_SpLensCodeSmartQuote;
                this.ItemsourceCount = ComHelpLensCode.UHV_B_SpLensCodeSmartQuote.Count;
            });
        }
    }
}
