...
{
    public class VMWare_Bill_Transfer_Lens_List : VMList
    {
        ...
        public VMWare_Bill_Transfer_Lens_List()
            : base("ID", "Ware_Bill_Transfer_Lens")
        {
        ...
        protected override string PrepareDDsInfoListQueryName()
        {
            ...
            return "GetV_Ware_Bill_Transfer_LensList";
        }
