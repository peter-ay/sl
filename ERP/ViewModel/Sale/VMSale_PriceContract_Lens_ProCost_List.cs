...
{
    public class VMSale_PriceContract_Lens_ProCost_List : VMList
    {
        #region Property
        ...
        public VMSale_PriceContract_Lens_ProCost_List()
            : base("LensCode", "Sale_PriceContract_Lens_ProCost", isAutoRefresh: true)
        {
