...
{
    public class VMSale_PriceContract_Frame_List : VMList
    {
        #region Property
        ...
        public VMSale_PriceContract_Frame_List()
            : base("FrameCode", "Sale_PriceContract_Frame", isAutoRefresh: true)
        {
        ...
        {
            ERP.Common.ComExport.Export(this.VMNameAuthority.Replace("_List", ""), @" BID='" + this.BID + "'", " FrameCode", " FrameCode,Price,PriceJM,InvTitle ");
        }
