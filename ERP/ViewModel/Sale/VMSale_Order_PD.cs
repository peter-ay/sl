...
{
    public class VMSale_Order_PD : VMBillPD
    {
        #region property
        ...
        //{
        //    return "GetV_Sale_Order_PDBill";
        //}

        //protected override string PrepareDDsInfoSubQueryName()
        //{
        //    return "GetV_Sale_Order_PDDetailList";
        //}

        //protected override void PrepareDContextMain()
        //{
        //    this.DContextMain = new V_Sale_Order_PD();
        //}
        ...
        //    var cDX = this.DContextMain as V_Sale_Order_PD;
