...
{
    public class VMSale_Order_SD_ReOrder : VMBill
    {
        #region 独有属性
        ...
        public VMSale_Order_SD_ReOrder()
        ...
        {
            //Messenger.Default.Register<V_Sale_Order_SD>(this, "Sale_Order_SD_ReOrder" + "_New", (msg) =>
            //{
            //    var _DC2 = msg;
            //    ComCopyProperties.Copy(this._DC, _DC2);
            //});
        ...
        {
            //var _DC = this.DContextMain as V_Sale_Order_SD_ReOrder;
        ...
        private void ExecuteCmdKeyDownWhCode(KeyEventArgs parameter)
        {
            ...
            //var cDX = this.DContextMain as V_Sale_Order_SD_ReOrder;
            //if (cDX == null || cDX.EditState != 1)
            //    return;
