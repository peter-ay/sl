...
{
    public class VMSale_PriceTemplate_Lens_ProCost_List : VMList
    {
        #region Property
        ...
        public VMSale_PriceTemplate_Lens_ProCost_List()
            : base("LensCode", "Sale_PriceTemplate_Lens_ProCost", "lensCode", isAutoLoad: false)
        {
