...
{
    public class VMSale_PriceContract_FrameSet_List : VMList
    {
        #region Property
        ...
        public VMSale_PriceContract_FrameSet_List()
            : base("FrameCode", "Sale_PriceContract_FrameSet", isAutoRefresh: true)
        {
