...
{
    public class VMSale_PriceContract_Lens : VMBill
    {
        #region Property

        private string _BID;

        private V_Sale_PriceContract_Lens _DC
        {
            get
            {
                return this.DContextMain as V_Sale_PriceContract_Lens;
            }
        }
        ...
        public VMSale_PriceContract_Lens()
            : base("LensCode", "Sale_PriceContract_Lens")
        {
