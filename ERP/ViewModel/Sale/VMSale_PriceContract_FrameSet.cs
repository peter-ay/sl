...
{
    public class VMSale_PriceContract_FrameSet : VMBill
    {
        #region Property

        private string _BID;

        private V_Sale_PriceContract_FrameSet _DC
        {
            get
            {
                return this.DContextMain as V_Sale_PriceContract_FrameSet;
            }
        }
        ...
        public VMSale_PriceContract_FrameSet()
            : base("FrameCode", "Sale_PriceContract_FrameSet")
        {
