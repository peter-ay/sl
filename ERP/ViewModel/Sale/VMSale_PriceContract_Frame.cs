...
{
    public class VMSale_PriceContract_Frame : VMBill
    {
        #region Property

        private string _BID;

        private V_Sale_PriceContract_Frame _DC
        {
            get
            {
                return this.DContextMain as V_Sale_PriceContract_Frame;
            }
        }
        ...
        public VMSale_PriceContract_Frame()
            : base("FrameCode", "Sale_PriceContract_Frame")
        {
