...
{
    public class VMPur_PriceContract_FrameSet : VMBill
    {
        #region Property

        private string _BID;

        private V_Pur_PriceContract_FrameSet _DC
        {
            get
            {
                return this.DContextMain as V_Pur_PriceContract_FrameSet;
            }
        }
        ...
        public VMPur_PriceContract_FrameSet()
            : base("FrameCode", "Pur_PriceContract_FrameSet")
        {
