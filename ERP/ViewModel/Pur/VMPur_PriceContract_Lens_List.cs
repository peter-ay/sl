...
{
    public class VMPur_PriceContract_Lens_List : VMList
    {
        #region Property
        ...
        public VMPur_PriceContract_Lens_List()
            : base("LensCode", "Pur_PriceContract_Lens", isAutoRefresh: true)
        {
        ...
        {
            ERP.Common.ComExport.Export(this.VMNameAuthority.Replace("_List", ""), @" BID='" + this.BID + "'", " LensCode", " LensCode,SPH1,SPH2,CYL1,CYL2,ADD1,ADD2,Dia,P1,P2,P1JM,P2JM,InvTitle ");
        }
