...
{
    public class VMPur_Quote : VMBill
    {
        #region property

        private V_Pur_Quote _DC
        {
            get
            {
                return this.DContextMain as V_Pur_Quote;
            }
        }
        ...
        {
            V_Pur_Quote _Item = item as V_Pur_Quote;
            this._DC.SpCode = _Item.SpCode;
