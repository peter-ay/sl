...
{
    public class VMPur_PriceContract_Lens_ProCost : VMBill
    {
        #region Property

        private string _BID;

        private V_Pur_PriceContract_Lens_ProCost _DC
        {
            get
            {
                return this.DContextMain as V_Pur_PriceContract_Lens_ProCost;
            }
        }
        ...
        public VMPur_PriceContract_Lens_ProCost()
            : base("LensCode", "Pur_PriceContract_Lens_ProCost")
        {
