...
{
    public class VMB_Lens_ProControl_List : VMList
    {
        #region Property
        ...
        public VMB_Lens_ProControl_List()
            : base("LensCode", "B_Lens_ProControl", "lenscode", isAutoLoad: false)
        {
            IsChildWindow = true;
        ...
        private void AddPrice()
        {
            ...
            //model.Sub_ProControl = new MB_Lens_ProControl()
            //{
            //    CB = this.CB,
            //    ChB = this.ChB,
            //    CS = this.CS,
            ...
            //this.IsBusy = true;
            //_DS.AddProControl(USysInfo.DBCode, USysInfo.LgIndex, model, geted =>
            //{
            //    this.IsBusy = false;
            //    if (geted.HasError)
            //    {
        ...
        protected override void Delete()
        {
            //DSB_Lens _DS = new DSB_Lens();
            //this.IsBusy = true;
            //_DS.DeleteProControl(USysInfo.DBCode, USysInfo.LgIndex, this.GridListSelectedCodes, geted =>
            //{
            //    this.IsBusy = false;
            //    if (geted.HasError)
            //    {
        ...
        private void EditPrice()
        {
            //DSB_Lens _DS = new DSB_Lens();
            //this.IsBusy = true;
            //_DS.EditProControl(USysInfo.DBCode, USysInfo.LgIndex, this.GridListSelectedCodes, P1, P2, geted =>
            //{
            //    this.IsBusy = false;
            //    if (geted.HasError)
            //    {
        ...
        private void CopyPrice()
        {
            //DSB_Lens _DS = new DSB_Lens();
            //this.IsBusy = true;
            //_DS.CopyProControl(USysInfo.DBCode, USysInfo.LgIndex, this.LensCodeCopy, this.SKeyCode, geted =>
            //{
            //    this.IsBusy = false;
            //    if (geted.HasError)
            //    {
