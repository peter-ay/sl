...
{
    public class VMB_Material_LensClass_Usage_List : VMList
    {
        public VMB_Material_LensClass_Usage_List()
            : base("SN", "B_Material_LensClass_Usage", isAutoRefresh: true)
        {
        ...
        //    var p = _DS.GetV_B_Material_LensClass_UsageListQuery(USysInfo.DBCode, _Str);
        //    _DS.Load(p, geted =>
        //    {
        //        if (geted.HasError)
        //        {
