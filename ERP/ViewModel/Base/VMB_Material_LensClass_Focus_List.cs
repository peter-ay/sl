...
{
    public class VMB_Material_LensClass_Focus_List : VMList
    {
        public VMB_Material_LensClass_Focus_List()
            : base("SN", "B_Material_LensClass_Focus", isAutoRefresh: true)
        {
        ...
        //    var p = _DS.GetV_B_Material_LensClass_FocusListQuery(USysInfo.DBCode, _Str);
        //    _DS.Load(p, geted =>
        //    {
        //        if (geted.HasError)
        //        {
