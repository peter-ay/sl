...
{
    public class VMB_Material_LensClass_Index_List : VMList
    {
        public VMB_Material_LensClass_Index_List()
            : base("SN", "B_Material_LensClass_Index", isAutoRefresh: true)
        {
        ...
        //    var p = _DS.GetV_B_Material_LensClass_IndexListQuery(USysInfo.DBCode, _Str);
        //    _DS.Load(p, geted =>
        //    {
        //        if (geted.HasError)
        //        {
