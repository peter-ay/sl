...
{
    public class VMB_Warehouse_Right_Browse : VMList
    {
        ...
        public VMB_Warehouse_Right_Browse()
        ...
        {
            var _DDs = ComDDSFactory.Get(ComDSFactory.Erp, "GetV_B_WarehouseRightBrowseGpCode", ReSetSelectCodes, true);
        ...
        private void ReSetSelectCodes(object s, LoadedDataEventArgs geted)
        {
            ...
            foreach (V_B_Warehouse_Browse it2 in items2)
            {
